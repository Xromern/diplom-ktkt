 ...
 */
final class Version20190512085034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_code DROP student_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_code ADD student_id INT DEFAULT NULL');
